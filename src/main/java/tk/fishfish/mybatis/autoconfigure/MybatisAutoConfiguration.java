...
/**
 * Mybatis配置，将 ibatis configuration 替换为 tk configuration
 *
 * @author 奔波儿灞
 * @version 1.0.0
 */
...
public class MybatisAutoConfiguration {
    ...
    public MybatisAutoConfiguration(MybatisProperties properties, ObjectProvider<Interceptor[]> interceptorsProvider,
                                    ...
                                    ObjectProvider<List<ConfigurationCustomizer>> configurationCustomizersProvider, MapperHelper mapperHelper) {
    ...
    private void applyConfiguration(SqlSessionFactoryBean factory) {
        ...
        tkConfiguration.setMapperHelper(this.mapperHelper);
        properties.setConfiguration(tkConfiguration);

        if (configuration != null && !CollectionUtils.isEmpty(this.configurationCustomizers)) {
            for (ConfigurationCustomizer customizer : this.configurationCustomizers) {
                customizer.customize(tkConfiguration);
            }
        }
        factory.setConfiguration(tkConfiguration);
    }
